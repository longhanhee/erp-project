	...
	function getSystemConfig() {
        ...
        $.ajax({
            ...
            //此处添加错误处理
            error:function() {
                $.messager.alert('Truy vấn thất bại','Truy vấn thông tin cấu hình hệ thống là bất thường. Vui lòng thử lại sau!','error');
                return;
            }
        });
        return info;
    ...
    function turnBillDetailPage(number, type) {
        js.addTabPage(null, "Chi tiết tài liệu", "/pages/materials/bill_detail.html?n="+ number + "&type=" + type);
    }
    ...
    function checkPower() {
        ...
        if(loginName == "admin") {
            $.messager.alert('Gợi ý','Quản trị viên không thể tăng dữ liệu biểu mẫu！','warning');
            res = true;
        } else {
            res = false;
		}
