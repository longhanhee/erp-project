...
public final class HttpClient {
    ...
    public static JSONObject httpGet(String url){
        ...
        try {
            ...
            if (SC_OK != statusCode) {
                throw new RuntimeException(String.format("Truy vấn %s có ngoại lệ", url));
            }
            ...
            e.printStackTrace();
            throw new RuntimeException(String.format("%s", url) + "Một ngoại lệ xảy ra trong truy vấn");
        } finally {
            try {
                client.close();
            } catch (IOException e) {
    ...
    public static String httpPost(String url, String param) {
        ...
        try {
            ...
            logger.info("Tình trạng:"+statusCode+"Dữ liệu:"+data);
            return data;
        } catch(Exception e){
